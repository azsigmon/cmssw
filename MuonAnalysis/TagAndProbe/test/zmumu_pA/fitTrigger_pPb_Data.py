...
process.TnP_Trigger = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
     ## Input, output 
    InputFileNames = cms.vstring("file:tnpZ_all_data_v5.root"),
    OutputFileName = cms.string("fits2_Trigger_Data_v5_BWResCBExp.root"),
    ...
    Categories = cms.PSet(
	QualityMu = cms.vstring("QualityCuts", "dummy[pass=1,fail=0]"),
	PAMu12 = cms.vstring("HLT_PAMu12", "dummy[pass=1,fail=0]"),
    ...
    Efficiencies = cms.PSet(
        Trig_pt = cms.PSet(
            ...
            EfficiencyCategoryAndState = cms.vstring("PAMu12", "pass"), ## Numerator definition
