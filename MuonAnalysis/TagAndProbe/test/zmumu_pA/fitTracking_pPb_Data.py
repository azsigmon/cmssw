...
process.TnP_Tracking = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    OutputFileName = cms.string("fits2_TrackerMuon_Data_v5_Voigt2Exp.root"),
    ...
    Efficiencies = cms.PSet(
        Trk_pt = cms.PSet(
            ...
            EfficiencyCategoryAndState = cms.vstring("TrackerMu","pass"), ## Numerator definition
		...
		outerValidHits = cms.vstring("pass"),
            ...
            BinToPDFmap = cms.vstring("Voigt2Exp"), ## PDF to use, as defined below
        ),
        Trk_eta = cms.PSet(
            UnbinnedVariables = cms.vstring("mass"),
            EfficiencyCategoryAndState = cms.vstring("TrackerMu","pass"), ## Numerator definition
